...
import com.jcoy0907.cccomponents.event.handler.PeripheralContainerHandler;
import com.jcoy0907.cccomponents.event.handler.PropertiesHandler;
import com.jcoy0907.cccomponents.hooks.ComputerCraftHooks;
import com.jcoy0907.cccomponents.tiles.*;
import com.jcoy0907.cccomponents.villagers.TradeHandler;
...
public class CommonProxy {
	...
	public void setupVillagers() {
		while (VillagerRegistry.getRegisteredVillagers().contains(CCComponents.VILLAGER_ID)) //Dynamic villager ids ftw?
			CCComponents.VILLAGER_ID++;
		VillagerRegistry.instance().registerVillagerId(CCComponents.VILLAGER_ID);
		VillagerRegistry.instance().registerVillageTradeHandler(CCComponents.VILLAGER_ID, new TradeHandler());
	}
