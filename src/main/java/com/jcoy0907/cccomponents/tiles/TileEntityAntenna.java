...
import com.jcoy0907.cccomponents.lua.LuaObjectHUD;
import com.jcoy0907.cccomponents.network.ScaleRequestPacket;
		...
		switch (method) {
			...
			case 1:
				synchronized (this) {
					...
					CCComponents.NETWORK.sendTo(new ScaleRequestPacket(this, computer.getID(), world), (EntityPlayerMP) Util.getPlayer((String)arguments[0]));
