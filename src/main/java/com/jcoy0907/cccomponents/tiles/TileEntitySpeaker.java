...
import com.jcoy0907.cccomponents.network.AudioPacket;
import com.jcoy0907.cccomponents.network.SynthPacket;
import com.jcoy0907.cccomponents.reference.Config;
import com.jcoy0907.cccomponents.utils.ReflectionHelper;
import com.jcoy0907.cccomponents.utils.TranslateUtils;
...
public class TileEntitySpeaker extends MountedTileEntity {
	...
	public void updateEntity() {
		...
		if (packetInfo[0] != null) {
			CCComponents.NETWORK.sendToAllAround(new AudioPacket((String)packetInfo[1], (String)packetInfo[2], xCoord, yCoord, zCoord, id, side), new NetworkRegistry.TargetPoint(id, xCoord, yCoord, zCoord, (Double)packetInfo[3]));
			packetInfo[0] = null;
		}
	}
	...
	public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments) throws LuaException, InterruptedException {
		...
		if (method == 0) {
			...
			CCComponents.NETWORK.sendToAllAround(new SynthPacket(text, voice, pitch, pitchRange, pitchShift, rate, volume, xCoord, yCoord, zCoord, id, side), new NetworkRegistry.TargetPoint(id, xCoord, yCoord, zCoord, range));
