package com.jcoy0907.cccomponents.reference;

import com.jcoy0907.cccomponents.Tags;

public class Reference {
	public static final String MOD_ID = Tags.MODID;
	public static final String MOD_NAME = Tags.MODNAME;
	public static final String VERSION = Tags.VERSION;
	public static final String SERVER_PROXY_CLASS = "com.jcoy0907.cccomponents.proxy.CommonProxy";
	public static final String CLIENT_PROXY_CLASS = "com.jcoy0907.cccomponents.proxy.ClientProxy";
	public static final String GUI_FACTORY_CLASS = "com.jcoy0907.cccomponents.client.gui.GUIFactory";
