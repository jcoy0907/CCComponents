package com.jcoy0907.cccomponents.entities;

import com.jcoy0907.cccomponents.CCComponents;
import com.jcoy0907.cccomponents.network.RidableTurtlePacket;
import com.jcoy0907.cccomponents.reference.Config;
import com.jcoy0907.cccomponents.turtles.TurtleRidable;
	...
	private void checkPlayerMovementRequest() {
		if (this.worldObj.isRemote && this.riddenByEntity != null &&
			...
			if (Keyboard.isKeyDown(Keyboard.KEY_W)) { // TODO Forge keybinds
				CCComponents.NETWORK.sendToServer(new RidableTurtlePacket(this.getEntityId(),
