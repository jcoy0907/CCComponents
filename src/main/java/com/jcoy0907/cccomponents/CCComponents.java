...
import com.jcoy0907.cccomponents.hooks.ComputerCraftNotFoundException;
...
import com.jcoy0907.cccomponents.init.Recipes;
import com.jcoy0907.cccomponents.mount.DynamicMount;
import com.jcoy0907.cccomponents.network.*;
import com.jcoy0907.cccomponents.pocket.PocketMotionDetector;
import com.jcoy0907.cccomponents.pocket.PocketPeripheralContainer;
import com.jcoy0907.cccomponents.proxy.CommonProxy;
import com.jcoy0907.cccomponents.reference.Config;
import com.jcoy0907.cccomponents.reference.Reference;
import com.jcoy0907.cccomponents.turtles.*;
...
@Mod(modid= Reference.MOD_ID,name = Reference.MOD_NAME,version = Reference.VERSION/*, guiFactory = Reference.GUI_FACTORY_CLASS*/, dependencies = "after:CollectiveFramework;after:ComputerCraft")
public class CCComponents {
	...
	public static CCComponents instance;
	...
	public static String BASE_PPP_DIR = "./mods/CC Components/";
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		NETWORK = NetworkRegistry.INSTANCE.newSimpleChannel("ccc");
		...
		NETWORK.registerMessage(ChatPacket.ChatPacketHandler.class, ChatPacket.class, 2, Side.CLIENT);
		NETWORK.registerMessage(ScaleRequestPacket.ScaleRequestPacketHandler.class, ScaleRequestPacket.class, 3, Side.CLIENT);
		NETWORK.registerMessage(ScaleRequestResponsePacket.ScaleRequestResponsePacketHandler.class, ScaleRequestResponsePacket.class, 4, Side.SERVER);
		NETWORK.registerMessage(CommandPacket.CommandPacketHandler.class, CommandPacket.class, 5, Side.CLIENT);
		NETWORK.registerMessage(ParticlePacket.ParticlePacketHandler.class, ParticlePacket.class, 6, Side.CLIENT);
		NETWORK.registerMessage(InputEventPacket.InputEventPacketHandler.class, InputEventPacket.class, 7, Side.SERVER);
		NETWORK.registerMessage(GuiPacket.GuiPacketHandler.class, GuiPacket.class, 8, Side.CLIENT);
		NETWORK.registerMessage(TextFieldInputEventPacket.TextFieldInputEventPacketHandler.class, TextFieldInputEventPacket.class, 9, Side.SERVER);
		NETWORK.registerMessage(RidableTurtlePacket.RidableTurtlePacketHandler.class, RidableTurtlePacket.class, 10, Side.SERVER);
        NETWORK.registerMessage(PermCardChangePacket.PermCardChangePacketHandler.class, PermCardChangePacket.class, 11, Side.SERVER);
		NETWORK.registerMessage(SynthPacket.SynthPacketHandler.class, SynthPacket.class, 12, Side.CLIENT);
		NETWORK.registerMessage(SynthResponsePacket.SynthResponsePacketHandler.class, SynthResponsePacket.class, 13, Side.SERVER);
	...
	public void init(FMLInitializationEvent event) {
		...
		ForgeChunkManager.setForcedChunkLoadingCallback(CCComponents.instance, new PeripheralChunkLoader.LoaderHandler());
	}
