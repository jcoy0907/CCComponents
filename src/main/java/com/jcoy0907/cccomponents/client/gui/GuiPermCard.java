...
import com.jcoy0907.cccomponents.network.PermCardChangePacket;
...
public class GuiPermCard extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        fontRendererObj.drawString(StatCollector.translateToLocal("cccomponents.inv.permCard"), x + 22, y + 5, 0x313131);
        fontRendererObj.drawString(StatCollector.translateToLocal("cccomponents.inv.permCard.perms"), x + 32, y + 20, 0x313131);
        fontRendererObj.drawString(StatCollector.translateToLocal("cccomponents.inv.permCard.get"), x + 25, y + 40, 0x313131);
        fontRendererObj.drawString(StatCollector.translateToLocal("cccomponents.inv.permCard.withdraw"), x + 25, y + 60, 0x313131);
        fontRendererObj.drawString(StatCollector.translateToLocal("cccomponents.inv.permCard.deposit"), x + 25, y + 80, 0x313131);
    }
    ...
    {
        CCComponents.NETWORK.sendToServer(new PermCardChangePacket(canGetStacks, canWithdraw, canDeposit));
    }
}
