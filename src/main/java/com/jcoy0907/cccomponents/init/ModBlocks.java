...
import com.jcoy0907.cccomponents.blocks.*;
import com.jcoy0907.cccomponents.items.ItemBlockPeripheralContainer;
import com.jcoy0907.cccomponents.items.ItemBlockTurtle;
...
public class ModBlocks {
	...
	public static void init(){
		...
		if (Loader.isModLoaded("Forestry")) {
			CCComponents.LOGGER.info("Forestry is loaded! Registering analyzer peripherals...");
			...
			CCComponents.LOGGER.info("Forestry not found, skipping analyzer peripherals");
		...
		if (Loader.isModLoaded("appliedenergistics2")) {
			CCComponents.LOGGER.info("Applied Energistics is loaded! Registering the ME Bridge...");
			GameRegistry.registerBlock(meBridge, "meBridge");
		} else
			CCComponents.LOGGER.info("Applied Energistics not found, skipping the ME Bridge");
